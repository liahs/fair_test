...
const SmallDropDown = ({ handleChange }) => {
    ...
    return (
        <Box >
            <Box onClick={() => {
                setOpen(!open)
            }} sx={{ width: '47px', height: '35px', justifyContent: "space-around", alignItems: 'center', display: 'flex', background: 'white', borderRadius: '5px', border: '2px solid #DEDEDE', marginX: '5px' }}>
