...
const LiveMarketComponent = ({ team, team_2 }) => {
    ...
    return (
        <Box sx={{ width: '99%', display: 'flex', position: 'relative', marginY: '6px', alignSelf: 'center', justifyContent: 'space-evenly', flexDirection: { mobile: 'column', laptop: 'row' } }} >
            ...
            <Box sx={{ width: '99%', alignSelf: 'center', display: 'flex', marginTop: { mobile: '2px', laptop: 0 } }}>
