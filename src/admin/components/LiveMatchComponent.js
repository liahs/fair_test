...
import { ARROWUP, Header, INDIA, Info, Lock, Logout, PAKISTAN, TIME, UD } from "../../assets/index"
import { useState } from "react"

const LiveMatchComponent = ({ }) => {
    const [visible, setVisible] = useState(true)
    return (
        <Box sx={[{ position: 'relative', width: { tablet: "55%", mobile: "98%", laptop: '100%' }, display: 'flex', flexDirection: 'column', alignSelf: 'center', marginX: { laptop: '0vw', mobile: '0px', tablet: '0px' }, marginY: { laptop: ".5vh", }, borderRadius: '2px', background: 'white', alignSelf: { mobile: 'center', tablet: 'center', laptop: "flex-start" } }]}>
            ...
            {visible && <Box sx={{ width: '99.2%', height: 68, top: 40, left: '2px', background: 'rgba(0,0,0,0.5)', position: 'absolute' }} >
