            ...
            <Box sx={[style]}>
                ...
                <Box sx={{ background: "white" }}>
                    ...
                    <Box sx={{ marginTop: "50px", display: "flex" }}>
                        ...
                        }} title={"Withdraw"} containerStyle={{ marginX: "3px" }} />
                        <BoxButton onClick={() => {
                            dispatch(setModalOpen(false))
                            setTimeout(() => {
                                dispatch(setCredModalOpen(true))
                            }, 500)

                        }} title={"Set Credit Limit"} labelStyle={{}} />
                    </Box>
                    <Box sx={{ marginTop: "3px", display: "flex" }}>
                        <BoxButton
                            onClick={() => {
                                dispatch(setModalOpen(false))
                                setTimeout(() => {
                                    dispatch(setCmModalOpen(true))
                                }, 500)

                            }}
                            title={"Change Password"} labelStyle={{}} />
                        <BoxButton title={"Lock/Unlock"} containerStyle={{ marginX: "3px" }} />
                        <BoxButton onClick={() => {
                            dispatch(setModalOpen(false))
                            setTimeout(() => {
                                dispatch(setExpoModalOpen(true))
                            }, 500)
