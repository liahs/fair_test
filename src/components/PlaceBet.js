...
const PlaceBet = ({ open, handleClose,season }) => {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', border: "2px solid white", borderRadius: "10px", overflow: "hidden", marginY: { mobile: '.7vh', laptop: '1vh' }, width: { mobile: "96%", laptop: '97%' }, marginLeft: {laptop:'1vw',mobile:"0px"}, alignSelf: { mobile: 'center', tablet: 'center', laptop: 'flex-start', } }} >
