...
const Odds = ({ upcoming, onClick }) => {
    ...
    const matchesMobile = useMediaQuery(theme.breakpoints.down("laptop"))
    return (
        <Box onClick={onClick} sx={{ display: 'flex', position: 'relative', flexDirection: 'column', marginY: { mobile: '.7vh', laptop: '1.5vh' }, width: { table: "100%", mobile: "100%", laptop: '95%' }, marginX: '1vw', alignSelf: { mobile: 'center', tablet: 'center', laptop: 'flex-start', } }}>



            {!upcoming && <Box sx={{ width: '50px', height: '13px', justifyContent: 'center', display: 'flex', alignItems: 'center', background: '#46CF4D', position: 'absolute', marginTop: -1, borderRadius: '3px', marginLeft: 1 }} >
                <Typography sx={{ fontStyle: 'italic', fontSize: { laptop: '10px', mobile: "8px" }, fontWeight: '600', color: 'white' }} >LIVE</Typography>
            </Box>}
            {upcoming && <Box sx={{ width: '70px', height: '13px', justifyContent: 'center', display: 'flex', alignItems: 'center', background: '#129FFE', position: 'absolute', marginTop: -1, borderRadius: '3px', marginLeft: 1 }} >
            ...
            <Box sx={{ display: 'flex', background: 'white', height: '38px', width: '100%' }} >
                ...
                <Box sx={{ display: 'flex', background: 'white', height: '38px', width: { laptop: '60%', mobile: '80%' }, justifyContent: { mobile: 'flex-end', laptop: 'center' }, alignItems: 'center' }} >
            ...
            <Box sx={{ display: 'flex', background: 'white', height: '38px', width: '100%' }} >
                <Box sx={{ display: 'flex', background: 'white', height: '38px', width: '40%', alignItems: 'center' }} >
                    ...
                    <Typography sx={{ color: 'black', fontSize: { laptop: '11px', tablet: '10px', mobile: "10px" }, marginLeft: '7px', fontWeight: '600' }} >Team B</Typography>
                </Box>
