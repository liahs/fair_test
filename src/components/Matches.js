...
const Odds = ({ upcoming, onClick }) => {
    ...
    const matchesMobile = useMediaQuery(theme.breakpoints.down("laptop"))
    return (
        <Box onClick={onClick} sx={{ display: 'flex', position: 'relative', flexDirection: 'column', marginY: { mobile: '.7vh', laptop: '1.5vh' }, width: { mobile: "96%", laptop: '95%' }, marginX: '1vw', alignSelf: { mobile: 'center', tablet: 'center', laptop: 'flex-start', }, background: 'white', padding: .2 }}>
            ...
            {upcoming && <Box sx={{ width: '70px', border: '1px solid white', height: { mobile: '20px', laptop: '13px' }, justifyContent: 'center', display: 'flex', alignItems: 'center', background: '#129FFE', position: 'absolute', marginTop: -1, borderRadius: '3px', marginLeft: 1 }} >
