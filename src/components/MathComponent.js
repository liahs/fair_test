...
const MatchComponent = ({ }) => {
    ...
    return (
        <Box sx={[{ width: { table: "55%", mobile: "80%", laptop: '95%' }, display: 'flex', flexDirection: 'column', marginX: { laptop: '1vw', mobile: '0px', tablet: '0px' }, marginY: '1vh', height: '18%', minHeight: '100px', background: 'white', alignSelf: { mobile: 'center', tablet: 'center', laptop: "flex-start" } }]}>
