...
const MatchComponent = ({ }) => {
    ...
    return (
        <Box sx={[{ width: { tablet: "55%", mobile: "97%", laptop: '100%' }, display: 'flex', flexDirection: 'column', marginX: { laptop: '0vw', mobile: '0px', tablet: '0px' }, marginY: "2vh", padding: '2px', borderRadius: '2px', background: 'white', alignSelf: { mobile: 'center', tablet: 'center', laptop: "flex-start" } }]}>
            ...
            <Box sx={{ display: 'flex', paddingBottom: '1vh', flexDirection: 'column', flex: 1, justifyContent: 'flex-end', borderBottom: '.4px solid gray' }} >
                <Box sx={{ display: 'flex' }} >
